...
import de.thm.mni.ip.util.config.DatabaseConfig;
...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        var databaseConfig = new DatabaseConfig(
                EnvironmentVariableReader.get("DB_JDBC_STRING", "jdbc:h2:mem:idp;DB_CLOSE_DELAY=-1"),
                EnvironmentVariableReader.get("DB_USER", "idp_user"),
                EnvironmentVariableReader.get("DB_PASSWORD", "idp_password")
        );
